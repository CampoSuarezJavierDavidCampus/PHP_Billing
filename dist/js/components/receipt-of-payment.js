...
export class ReceiptOfPayment extends HTMLElement {
  ...
  getData(){
    let {fecha,cliente,documento} = document.querySelector('.facturacion__form');
  ...
  createRows(){
    let 
      products = Object.values(LocalDB.db),     
      html = '',
      total = 0;
  ...
  async connectedCallback() {
    ...
    this.getData();
    this.shadowRoot.querySelector(".recibo__close").addEventListener("click",this);
  }  
}
